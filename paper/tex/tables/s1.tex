...
\toprule
\rowcolor{tablehead}\makecell[l]{Risk group} & \makecell[l]{County rurality} & \makecell[r]{Men} & \makecell[r]{Waited more\\than 90 days (\%)} & \makecell[r]{Median\\days} & \makecell[r]{90th percentile\\days} \\
\midrule
