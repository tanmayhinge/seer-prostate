...
\toprule
\rowcolor{tablehead}\makecell[l]{Stratum} & \makecell[l]{Model} & \makecell[r]{Log-loss\\skill (\%)} & \makecell[r]{Brier\\skill (\%)} & \makecell[r]{AUC} & \makecell[r]{Calibration\\intercept} & \makecell[r]{Calibration\\slope} \\
\midrule
