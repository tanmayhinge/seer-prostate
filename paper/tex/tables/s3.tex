...
\end{tabular}
\par\smallskip
\begin{minipage}{\linewidth}\scriptsize Percentage points of out-of-fold log-loss skill added by area and marital characteristics (step 1 to 2), with 95\% cluster bootstrap intervals (first fold seed, 500 resamples, no refitting). Tuning was not repeated per seed. Added by protocol amendment 1.9 and specified before being run.\end{minipage}
\end{table}
