...
\toprule
\makecell[l]{Stratum} & \makecell[l]{Model} & \makecell[r]{Primary analysis\\(tuned at step 3)} & \makecell[r]{Tuned at\\each step} & \makecell[r]{Mean (range) over\\10 fold seeds} & \makecell[r]{Clustered by county\\income band only} \\
\midrule
