...
\toprule
\rowcolor{tablehead}\makecell[l]{Scenario} & \makecell[r]{Threshold\\(days)} & \makecell[r]{Men} & \makecell[r]{Delayed\\(\%)} & \makecell[r]{Added, logistic\\(95\% interval)} & \makecell[r]{Added, LightGBM\\(95\% interval)} & \makecell[r]{Area\\contrast} & \makecell[r]{Never married\\contrast} \\
\midrule
