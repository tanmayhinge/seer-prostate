...
\end{tabular}
\par\smallskip
\begin{minipage}{\linewidth}\scriptsize Erreygers-corrected concentration index (95\% cluster bootstrap interval) of waiting more than 90 days, ranking men by county median household income, poorest first. Positive values mean delay is concentrated in higher-income counties. Crude: not standardised for clinical features, and it does not separate income from rurality. Indices by period were added by protocol amendment 1.9 and specified before being run.\end{minipage}
\end{table}
