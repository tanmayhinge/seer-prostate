...
\toprule
\makecell[l]{County rurality} & \makecell[r]{Treated\\men} & \makecell[r]{Recorded\\men (\%)} & \makecell[r]{Lower\\bound (\%)} & \makecell[r]{Upper\\bound (\%)} & \makecell[r]{No recorded\\interval (\%)} & \makecell[r]{Weighted\\(\%)} \\
\midrule
