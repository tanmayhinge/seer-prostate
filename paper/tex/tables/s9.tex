...
\toprule
\rowcolor{tablehead}\makecell[l]{Stratum} & \makecell[l]{Model} & \makecell[r]{Skill at\\step 2 (\%)} & \makecell[r]{Clinical need\\added (95\% interval)} & \makecell[r]{Area and marital\\added (95\% interval)} & \makecell[r]{AUC at\\step 2} & \makecell[r]{Area\\contrast} & \makecell[r]{Never married\\contrast} \\
\midrule
