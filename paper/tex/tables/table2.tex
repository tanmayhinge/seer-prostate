...
\toprule
\makecell[l]{Risk group} & \makecell[l]{Model} & \makecell[r]{Men} & \makecell[r]{Skill at\\step 2 (\%)} & \makecell[r]{AUC at\\step 2} & \makecell[r]{Clinical need\\added (95\% interval)} & \makecell[r]{Area and marital\\added (95\% interval)} & \makecell[r]{Fold-seed\\range\textsuperscript{a}} \\
\midrule
